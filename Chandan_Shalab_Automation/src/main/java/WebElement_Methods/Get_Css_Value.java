...
public class Get_Css_Value
{
	...
	public static void main(String[] args) throws InterruptedException
	{
		//Specify type of browser and path of dricer
		    	...
		    	System.out.println(course_btn.getCssValue("font-size"));
		    	
		    	System.out.println(course_btn.getCssValue("font-family"));

		    	System.out.println(course_btn.getCssValue("color"));
