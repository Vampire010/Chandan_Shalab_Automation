...
public class Submit_ex 
{
	...
	public static void main(String[] args) throws InterruptedException
	{
				...
				driver.findElement(By.cssSelector("#customer\\.username")).sendKeys("Jay008");
				driver.findElement(By.cssSelector("#customer\\.password")).sendKeys("ram@1235");

				driver.findElement(By.cssSelector("#repeatedPassword")).sendKeys("ram@1235");
